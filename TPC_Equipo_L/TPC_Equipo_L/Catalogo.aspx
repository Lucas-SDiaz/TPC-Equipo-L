        ...
        <div class="col">
            <div class="card custom-card-size">
                <div class="card-body">
                    ...
                    <a href="detalleProducto.aspx?id=<%: producto.Id %>" style="display: flex; justify-content: center; align-items: center;" class="btn btn-primary btn-sm">Ver detalle</a>
                    <p></p>
                    <a href="carritoCompra.aspx?id=<%: producto.Id %>" style="display: flex; justify-content: center; align-items: center;" class="btn btn-primary btn-sm">Agregar al carrito</a>
                </div>
            </div>
        </div>
        <%  } %>
