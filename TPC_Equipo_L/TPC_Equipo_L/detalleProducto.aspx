...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-grid gap-2 d-md-block">
        <a href="carritoCompra.aspx?id=<%: producto.CodigoProducto %>" class="btn btn-primary" style="border-bottom-color: white">
    ...
    %><a href="catalogo.aspx" class="btn btn-secondary">Volver</a>
</asp:Content>
